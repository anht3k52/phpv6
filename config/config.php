...
$base_url = 'https://izalo.net/'; // Thay url web bạn
...
class CMSNT
{
    ...
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'bedcluuc_tuanori', 'bedcluuc_tuanori', 'bedcluuc_tuanori') or die ('Vui lòng kết nối đến DATABASE');
