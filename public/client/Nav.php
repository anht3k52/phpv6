                    ...
                    <ul class="main-menu">
                        ...
                        <li class="has-sub-menu"><a href="#">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="<?=BASE_URL('Recharge-Card');?>">Thẻ cào <strong
                                            class="badge badge-danger">Auto</strong></a></li>
                                <?php }?>
                                <?php if($CMSNT->site('api_momo') != '') { ?>
                                <li><a href="<?=BASE_URL('Recharge-Momo');?>">MOMO <strong
                                            class="badge badge-danger">Auto</strong></a></li>
                                <?php }?>
                                ...
                                <li><a href="<?=BASE_URL('Recharge-Thesieure');?>">THESIEURE <strong
                                            class="badge badge-danger">Auto</strong></a></li>
                                <?php }?>
                                <li><a href="<?=BASE_URL('Recharge-Bank');?>"><?=lang(62);?> <strong
                                            class="badge badge-danger">Auto</strong></a></li>
                            </ul>
                        </li>
