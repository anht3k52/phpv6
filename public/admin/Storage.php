        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-dark">
                    ...
                    <p>max_file_uploads hiện tại là: <b style="color: yellow;"><?=ini_get('max_file_uploads');?></b></p>
                </div>
            </div>
            <div class="col-md-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-danger Delete"
                                                data-path="../../backup/<?=$row;?>">DELETE</button></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                            </table>
        ...
        <div class="modal-content">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <br>
                    <i>Số lượng tải lên tối đa 1 lần của server bạn là <b style="color: red;"><?=ini_get('max_file_uploads');?></b> file backup.</i>
                </div>
