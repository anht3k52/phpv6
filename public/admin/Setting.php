                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control show-tick" name="right_panel" required>
                                        <option value="<?=$CMSNT->site('right_panel');?>">
                                            <?=$CMSNT->site('right_panel');?>
                                        </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control show-tick" name="display_list_login">
                                        <option value="<?=$CMSNT->site('display_list_login');?>"><?=$CMSNT->site('display_list_login');?>
                                        </option>
                                        <option value="ON">ON</option>
                                        <option value="OFF">OFF</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control show-tick" name="display_sold">
                                        <option value="<?=$CMSNT->site('display_sold');?>"><?=$CMSNT->site('display_sold');?>
                                        </option>
                                        <option value="ON">ON</option>
                                        <option value="OFF">OFF</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" placeholder="VD: 10" name="ck_ref" value="<?=$CMSNT->site('ck_ref');?>"
                                            class="form-control">
                                    </div>
